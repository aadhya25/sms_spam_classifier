...
disp_voting = ConfusionMatrixDisplay(confusion_matrix=cm_voting, display_labels=['Ham', 'Spam'])
...
# Get predicted probabilities (for the positive class, i.e., spam)
...
plt.plot(fpr_voting, tpr_voting, color='blue', label=f'Voting Classifier (AUC = {roc_auc_voting:.2f})')
